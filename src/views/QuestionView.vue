    ...
    <div class="question-view-container">
        <div class="question-view">
            ...
            <div class="question-content">
                <QuestionCharacter :jumping="hoveringYes" />
                <YesNoButtons @yes="onYes" @no="onNo" @hover-yes="hoveringYes = true"
                    @hover-yes-leave="hoveringYes = false" />
            </div>

            <div v-if="rejected" class="no-img-wrap" role="dialog" aria-modal="true" @click="rejected = false">
        ...
        <p class="footer-text">Esta página fue hecha a mano y con un poquito de código, pero sobre todo fue hecha con
            amor.</p>
    </div>
</template>
